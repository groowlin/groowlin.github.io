...
- `2024–2025 · Усилил доверие`
- `2025 · Усилил возврат`
- `2023–2024 · Замкнул цикл`
- `2025–2026 · Скоро будет`

Ограничения:

- не длиннее паттерна `2023–2024 · продуктовый дизайн`;
- после `·` 2-3 слова;
- не использовать роль, если роль повторяется почти во всех кейсах;
- не заявлять неподтвержденный результат как факт;
- формулировка после `·` начинается с большой буквы;
- формулировка должна показывать роль дизайнера через продуктовый эффект или честный статус ожидания.
